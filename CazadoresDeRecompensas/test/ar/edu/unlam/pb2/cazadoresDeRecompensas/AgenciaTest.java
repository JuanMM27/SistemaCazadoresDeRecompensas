...
*/
	...
	private void agregarProfugosALaZona(Zona zona) {
		Profugo profugo1 = new Profugo("Pablo", 10, 60, true);
		Profugo profugo2 = new Profugo("Jorge", 50, 30, false);
		Profugo profugo3 = new Profugo("Ramon", 40, 60, false);
		Profugo profugo4 = new Profugo("Leo", 60, 60, true);
		Profugo profugo5 = new Profugo("Raul", 10, 10, true);
		Profugo profugo6 = new Profugo("Martin", 50, 60, false);
		Profugo profugo7 = new Profugo("Oscar", 40, 80, false);
		Profugo profugo8 = new Profugo("Noe", 60, 60, true);
		Profugo profugo9 = new Profugo("Juan", 10, 30, true);
		Profugo profugo10 = new Profugo("Gabi", 50, 80, false);
		Profugo profugo11 = new Profugo("Mauri", 40, 60, false);
		Profugo profugo12 = new Profugo("Fer", 70, 60, true);
